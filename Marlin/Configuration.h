...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    // UM2 Custom Dual Extruder MK8 _ONE NOZZLE_
    #define DEFAULT_Kp  12.45
    #define DEFAULT_Ki   0.78
    #define DEFAULT_Kd  49.96

    // UM2 Custom Dual Extruder MK8 _TWO NOZZLES_
    // @TODO
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 93 } // UM2 Stock Extruder (black box)
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 7000, 7000, 50, 8000 }
...
#define HOMING_FEEDRATE_MM_M { (100*60), (100*60), (18*60) }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 100), (Y_MIN_POS + 10), 0 }
