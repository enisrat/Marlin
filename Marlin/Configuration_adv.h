...
#define HOMING_BACKOFF_POST_MM { 1, 9, 4 }  // (linear=mm, rotational=°) Backoff from endstops after homing
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 120*60, 120*60, 30*60, 6*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
